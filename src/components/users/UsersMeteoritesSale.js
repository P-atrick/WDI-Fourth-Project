  ...
  render() {
    ...
    return(
      <div className="container is-fluid">
        { ownProfile && <h1 className="navbar-margin">Your Meteorites for Sale</h1>}
        { !ownProfile && <h1 className="navbar-margin">{ this.state.user.username }{"'s Meteorites for Sale"}</h1>}
